...
book_music_game_1.children.create([{name:"文字/小説"},{name:"人文/社会"},{name:"ノンフィクション/教養"},{name:"地図/旅行ガイド"},{name:"ビジネス/経済"},{name:"健康/医学"},{name:"コンピューター/IT"},{name:"趣味/スポーツ/実用"},{name:"住まい/暮らし/子育て"},{name:"アート/エンタメ"},{name:"洋書"},{name:"絵本"},{name:"参考書"},{name:"その他"}])
...
#コスメ・香水・美容
cosmetics_perfume_Beauty = Category.create(name:"コスメ・香水・美容")
cosmetics_perfume_Beauty_1 = cosmetics_perfume_Beauty.children.create(name:"ベースメイク")
cosmetics_perfume_Beauty_1.children.create([{name:"ファンデーション"},{name:"化粧下地"},{name:"コントロールカラー"},{name:"BBクリーム"},{name:"CCクリーム"},{name:"コンシーラー"},{name:"フェイスパウダー"},{name:"トライアルセット/サンプル"},{name:"その他"}])
cosmetics_perfume_Beauty_2 = cosmetics_perfume_Beauty.children.create(name:"メイクアップ")
cosmetics_perfume_Beauty_2.children.create([{name:"アイシャドウ"},{name:"口紅"},{name:"リップグロス"},{name:"リップライナー"},{name:"チーク"},{name:"フェイスカラー"},{name:"マスカラ"},{name:"アイライナー"},{name:"つけまつげ"},{name:"アイブロウペンシル"},{name:"パウダーアイブロウ"},{name:"眉マスカラ"},{name:"トライアルセット/サンプル"},{name:"メイク道具/化粧小物"},{name:"美顔用品/美顔ローラー"},{name:"その他"}])
cosmetics_perfume_Beauty_3 = cosmetics_perfume_Beauty.children.create(name:"ネイルケア")
cosmetics_perfume_Beauty_3.children.create([{name:"ネイルカラー"},{name:"カラージェル"},{name:"ネイルベースコート/トップコート"},{name:"ネイルアート用品"},{name:"ネイルパーツ"},{name:"ネイルチップ/付け爪"},{name:"手入れ用具"},{name:"除光液"},{name:"その他"}])
cosmetics_perfume_Beauty_4 = cosmetics_perfume_Beauty.children.create(name:"香水")
cosmetics_perfume_Beauty_4.children.create([{name:"香水（女性用）"},{name:"香水（男性用）"},{name:"ユニセックス"},{name:"ボディミスト"},{name:"その他"}])
cosmetics_perfume_Beauty_5 = cosmetics_perfume_Beauty.children.create(name:"スキンケア/基礎化粧品")
cosmetics_perfume_Beauty_5.children.create([{name:"化粧水/ローション"},{name:"乳液/ミルク"},{name:"美容液"},{name:"フェイスクリーム"},{name:"洗顔料"},{name:"クレンジング/メイク落とし"},{name:"パック/フェイスマスク"},{name:"ジェル/ゲル"},{name:"ブースター/導入液"},{name:"アイケア"},{name:"リップケア"},{name:"トライアルセット/サンプル"},{name:"洗顔グッズ"},{name:"その他"}])
cosmetics_perfume_Beauty_6 = cosmetics_perfume_Beauty.children.create(name:"ヘアケア")
cosmetics_perfume_Beauty_6.children.create([{name:"シャンプー"},{name:"トリートメント"},{name:"コンディショナー"},{name:"リンス"},{name:"スタイリング剤"},{name:"カラーリング剤"},{name:"ブラシ"},{name:"その他"}])
cosmetics_perfume_Beauty_7 = cosmetics_perfume_Beauty.children.create(name:"ボディケア")
cosmetics_perfume_Beauty_7.children.create([{name:"オイル/クリーム"},{name:"ハンドクリーム"},{name:"ローション"},{name:"日焼け止め/サンオイル"},{name:"ボディソープ"},{name:"入浴剤"},{name:"制汗/デオドラント"},{name:"フットケア"},{name:"その他"}])
cosmetics_perfume_Beauty_8 = cosmetics_perfume_Beauty.children.create(name:"オーラルケア")
cosmetics_perfume_Beauty_8.children.create([{name:"口臭防止/エチケット用品"},{name:"歯ブラシ"},{name:"その他"}])
cosmetics_perfume_Beauty_9 = cosmetics_perfume_Beauty.children.create(name:"リラクゼーション")
cosmetics_perfume_Beauty_9.children.create([{name:"エッセンシャルオイル"},{name:"芳香機"},{name:"お香/香炉"},{name:"キャンドル"},{name:"リラクゼーショングッズ"},{name:"その他"}])
cosmetics_perfume_Beauty_10 = cosmetics_perfume_Beauty.children.create(name:"ダイエット")
cosmetics_perfume_Beauty_10.children.create([{name:"ダイエット食品"},{name:"エクササイズ用品"},{name:"体重計"},{name:"体脂肪計"},{name:"その他"}])
cosmetics_perfume_Beauty_11 = cosmetics_perfume_Beauty.children.create(name:"その他")
cosmetics_perfume_Beauty_11.children.create([{name:"健康用品"},{name:"看護/介護用品"},{name:"救急/衛生用品"},{name:"その他"}])
